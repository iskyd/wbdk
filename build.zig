...
pub fn build(b: *std.Build) void {
    ...
    lib.root_module.addImport("crypto", crypto);
    lib.root_module.addImport("base58", base58_module);
    ...
    lib_unit_tests.root_module.addImport("crypto", crypto);

    const run_lib_unit_tests = b.addRunArtifact(lib_unit_tests);

    const crypto_unit_tests = b.addTest(.{
        .root_source_file = b.path("crypto_unit_tests.zig"),
        .target = target,
        .optimize = optimize,
    });
